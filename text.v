...
module text(
    ...
    font_rom font_inst (
        .clk(clk_100MHz),
        .addr(rom_addr),    // L'indirizzo arriva combinatorio
        .data(rom_data)     // Il dato esce dopo 1 colpo di clock della ROM
    );

    // Estrazione istantanea del bit del font (Senza registro d'uscita)
